...
tree <- read.tree(text = "((odoros:0.00874026,(calurs:0.00426586,(arcgaz:0.00277041,(eumjub:0.00168815,zalcal:0.00162927):0.000815102):0.00166386):0.00662188):0,(((lepwed:0.00461382,(mirleo:0.00134209,mirang:0.00149935):0.00456857):0.000822777,neosch:0.00548077):0.00371419,(phovit:0.00197148,halgry:0.00195372):0.00495782):0.0184458);")
...
ggtree(tree, color = NA) +
  ...
  annotation_custom(odo,
                    ...
                    ymin = 1 - i_h/2.5,
                    ymax = 1 + i_h/2.5) +
  geom_text(data = tibble(x = c(.029, .0392),
                          y = c(3.5, 8.5),
                          label = gens),
            aes(label = label),
