...
read_win_gerp <- \(scf){read_tsv(glue("results/pinniped/gerp/tsv/gerp_snps_{scf}_summary.tsv.gz"))}
read_busco_gerp <- \(scf){read_tsv(glue("results/pinniped/gerp/tsv/gerp_busco_{scf}_summary.tsv.gz"))}
read_win_fst <- \(scf){read_tsv(glue("results/pinniped/fst/tsv/fst_snps_{scf}_summary.tsv.gz"))}
...
data_win_fst_vt <- read_tsv("results/fst_win.tsv.gz") |>
...
data_busco |>
  ...
  write_tsv("results/pinniped/busco_gerp_fst.tsv")
